...
import TextAreaDemo.DescriptionPane;
...
public class ComboBoxDemo extends Application {
	...
	private ImageView[] flagImage = { new ImageView(path + "image/ca.gif"), new ImageView(path + "image/china.gif"),
			new ImageView(path + "image/denmark.gif"), new ImageView(path + "image/fr.gif"),
			new ImageView(path + "image/germany.gif"), new ImageView(path + "image/india.gif"),
			new ImageView(path + "image/norway.gif"), new ImageView(path + "image/uk.gif"),
