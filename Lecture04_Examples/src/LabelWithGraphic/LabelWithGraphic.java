...
public class LabelWithGraphic extends Application {
  ...
  public void start(Stage primaryStage) {
	...
	path = path.substring(0,path.length()-4)+"image/us.gif";
	System.out.println( "Path: " + path);
	//System.out.println( "Path: " + getClass().getResource("/image/us.gif").toExternalForm());
    ImageView us = new ImageView(new Image(path));
